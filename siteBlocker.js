...
(function() {
    ...
    //     window.addEventListener('urlchange', (urlInfo) => {
    //         if(urlInfo.url.match(new RegExp(blockRegex))){
    //             console.log("Internal redirect URL matched with block regex")
    //             rerender()
    //             window.location.replace(redirectTo)
    //         }
    //     });
